<div class="modal fade" id="modalEnterprise" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <form class="modal-content" id="form-enterprise" enctype="multipart/form-data">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Nueva Empresa</h5>
            ...
            <div class="modal-body">
                ...
                <p class="text-purple text-bold">Imagen de contacto</p>
                <hr>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input name="img_fondo" type="file" class="custom-file-input" id="ruta_fondo" aria-describedby="fondo">
                                <label id="img_fondo" class="custom-file-label" for="ruta_fondo">Escoger archivo</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input name="img_small" type="file" class="custom-file-input" id="ruta_small_2" aria-describedby="small">

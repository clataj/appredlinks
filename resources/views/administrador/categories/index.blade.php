...
@include('administrador.categories.modals.modalCreate')

<!-- Edit Modal Text -->
@include('administrador.categories.modals.modalEditText')

<!-- Edit Modal Image-->
@include('administrador.categories.modals.modalEditImage')
...
<script src="{{ asset('assets/js/administrador/categories/categories.js') }}" type="module"></script>
<script src="{{ asset('assets/js/administrador/categories/forms.js') }}" type="module"></script>
@endprepend
